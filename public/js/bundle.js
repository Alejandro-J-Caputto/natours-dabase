    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:3000/api/v1/users/resetMyPassword' : 'http://localhost:3000/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (result.data.status === 'success') {
              (0, _alert.showAlert)('success', type.toUpperCase() + ' Data updated succesfully');
            }
...
var usertDataForm = document.querySelector('.form-user-data');
...
if (usertDataForm) {
  usertDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
